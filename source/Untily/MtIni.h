...
public:
    ...
    bool SaveFile(const char* szFilePath=nullptr);
...
public:
    void Serial(const char* szKey, int& nVal, bool bSerial);
    void Serial(const char* szKey, double& nVal, bool bSerial);
    void Serial(const char* szKey, std::string& strVal, bool bSerial);
    void Serial(const char* szKey, bool& nVal, bool bSerial);
	void Serial(const char* szKey, std::vector<int>& nVecIntVal, bool bSerial);
#ifdef _AFX
    void Serial(const char* szKey, CStringA& strVal, bool bSerial);
#endif
private:
...
public:
    ...
    bool SaveFile(const wchar_t* szFilePath = nullptr);
...
public:
    ...
    void SetDefDoubleBitNum(int num) {m_nDefDoubleBitNum = num; }
public:
    void Serial(const wchar_t* szKey, int& nVal, bool bSerial);
    void Serial(const wchar_t* szKey, double& nVal, bool bSerial);
    void Serial(const wchar_t* szKey, std::wstring& strVal, bool bSerial);
    void Serial(const wchar_t* szKey, bool& nVal, bool bSerial);
    void Serial(const wchar_t* szKey, std::vector<int>& nVecIntVal, bool bSerial);
#ifdef _AFX
    void Serial(const wchar_t* szKey, CStringW& strVal, bool bSerial);
#endif
private:
    static const int MAX_BUFF_STRING  = 2048; ///< 缓冲区大小
